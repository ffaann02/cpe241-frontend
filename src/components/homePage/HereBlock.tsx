                ...
                <div className="bg-slate-50 w-full max-w-5xl mt-10 p-8 rounded-2xl drop-shadow-sm mx-auto relative">
                    <div
                        ...
                        <button
                            ...
                            <IoMdAirplane className={`text-xl my-auto rotate-45 ${serviceIndex === 1 ? "text-purple-600":"text-slate-600"}`} />
                            <p className={`${serviceIndex === 1 ? "text-purple-600":"text-slate-600"} ml-0.5`}>จองไฟล์ท</p>
                        </button>
                        <button
                            ...
                            <IoIosGift className={`text-xl my-auto ${serviceIndex === 2 ? "text-purple-600":"text-slate-600"}`} />
                            <p className={`${serviceIndex === 2 ? "text-purple-600":"text-slate-600"} ml-0.5`}>โปรโมชั่น</p>
                        </button>
                    </div>
