    ...
    return (
        <div>
            <Modal isOpen={isOpen} onClose={onClose} isCentered motionPreset="slideInBottom">
                ...
                <ModalContent>
                    <ModalHeader>
                        {isDelete ? 'Delete Employee' : isAdd ? 'Add Employee' : 'Edit Employee Information'}
                    </ModalHeader>
                    <ModalCloseButton />
                    <ModalBody pb={6}>
                        <FormControl>
                            ...
                            {!isAdd && (
                                <Select
                                    ...
                                    value={editEmployeeInfo.employeeID}
                                >
                        ...
                        {!isDelete && (
                            <FormControl mt={1}>
                                ...
                                <Input
                                    name="phoneNumber"
                                    value={editEmployeeInfo.phoneNumber}
                        ...
                        {!isDelete && (
                            <FormControl mt={1}>
                                ...
                                <Input
                                    ...
                                    value={editEmployeeInfo.permissionLevel}
                                    onChange={handleInputChange}
                                />
                            </FormControl>
                        )}
                    ...
                    <ModalFooter>
                        {!isAdd && (
                            <Button colorScheme="blue" mr={3} onClick={() => handleSave(true)}>
                                Save Changes
                            </Button>
                        )}
                        {isAdd && (
                            <Button colorScheme="green" onClick={() => handleSave(false)}>
                                Add Employee
                            </Button>
                        )}
